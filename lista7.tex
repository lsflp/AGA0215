	...
	\part{}
		\begin{multicols}{2}
			\begin{enumerate}
				\item Fotosfera. %1
				\item Convecção. %2
				\item Espectro Branco-Amarelo. %3
				\item Eclipse Total. %4
				\item Ionizar. %5
				\item Pela  linha $H_\alpha$ (6563 {\AA}). %6
				\item Manchas solares. %7
				\item Fluxo de energia ou brilho aparente. %8
				\item Linear/Logarítmica. %9
				\item Luminosidade, temperatura e raio. %10 CONFIRMAR
			\end{enumerate}
		\end{multicols}
